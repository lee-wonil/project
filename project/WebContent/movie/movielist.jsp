		...
		<h2>영화 목록</h2>		
		  ...
		  <div class="col-4">							
			<div class="card" style="width: 18rem;">
				<img class="card-img-top" src="<%=vo.getM_pic() %>" height="150px" width="auto" alt="Card image cap" onclick="location.href='movieDetail.jsp?id=<%=vo.getM_id()%>'">
				<div class="card-body">
					<h5 class="card-title"><%=vo.getM_title() %></h5>
					<%double booknum = (((double)vo.getM_public()/new BookDAO().getCount())*100); %>
